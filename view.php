...
<div class="content view">
    ...
    <div class="btns">
        <a href="view.php?id=<?= $_GET['id'] ?>&status=closed" class="btn red">Fermer</a>
        <a href="view.php?id=<?= $_GET['id'] ?>&status=resolved" class="btn">Resoudre</a>
    </div>
    ...
    <div class="comments">
        ...
        <form action="" method="post">
            <textarea name="msg" placeholder="Entre ton commentaire..."></textarea>
            <input type="submit" value="Envoie de commentaire">
        </form>
    </div>
